...
handler.command = ['eliminarmakanakycoins', 'eliminarmakanaky', 'eliminarcoins', 'quitarmakanakycoins', 'quitarmakanaky', 'quitarcoins', 'delmakanakycoins', 'delmakanaky', 'delcoins'] 
handler.group = true
handler.rowner = true
