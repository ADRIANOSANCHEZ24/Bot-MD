...
┃ ${rpgg.emoticon('money')} *MakanakyCoins: » ${money}*
...
_2.Top MakanakyCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🐱 Minar MakanakyCoins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
