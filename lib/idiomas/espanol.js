...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE MAKANAKYBOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR MAKANAKYBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 𝗦𝘂𝗽𝗲𝗿 𝗠𝗮𝗸𝗮𝗻𝗮𝗸𝘆𝗕𝗼𝘁-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const eGataCoins = () => { return '🐱 Makanaky Coins' }
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar MakanakyBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar MakanakyBot en Grupos`}
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: botmakanaky@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de MakanakyBot 🐈'}
